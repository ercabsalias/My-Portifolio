  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        <p className={styles.sectionSubText}>MEUS TRABALHO</p>
      ...
      <div className="w-full flex">
        ...
        >
          Os projetos seguintes mostram minhas habilidades e experiência através
          ...
          nele. Isso reflete minha capacidade de resolver problemas complexos,
